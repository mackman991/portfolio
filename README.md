# Portfolio — Peter Mackin

Data analytics and quantitative finance projects, combining investment domain knowledge with Python, R and machine learning.
...
- Realistic portfolio sizing (3% per event, 30% gross cap): **CAGR 16.6% · Sharpe 3.90 · max drawdown −1.1%**
...
- Scenario modelling on missed-appointment rates; recommendations on workforce planning
- `Python` `Tableau`
...
Seven years in multi-asset portfolio management and performance attribution (CFA Level II, IMC), combined with hands-on Python, SQL and machine-learning skills (LSE Data Analytics Career Accelerator, Distinction). Currently building LLM-powered agent workflows using the Claude API to automate investment research and reporting.
